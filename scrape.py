...
price_data = hotel_list.li.article.section.aside.div.a.ins.text
hotel_name = hotel_data.h3.text
...
hotel_resp_module = hotel_data.find('div', class_ ="details resp-module")
...
print("Price of Room: " + str(price_data[2:]))
